        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12">
            ...
            <div className="flex items-center gap-2.5 text-lg">
              ...
              <span>AgriResort Fra' Viaco, Localita' Mezzano </span>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-4 justify-center">
          <Link
            to="/logistics"
            className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white border border-white/30 px-5 py-2 sm:px-8 sm:py-2.3 rounded-full text-sm sm:text-base font-medium transition-all duration-200 hover:scale-105 transform"
          >
            Logistics
          </Link>
          <Link
            to="/rsvp"
            className="bg-pale-yellow hover:bg-white text-black px-5 py-2 sm:px-8 sm:py-2.3 rounded-full text-sm sm:text-base font-medium transition-colors duration-200 hover:scale-105 transform"
          >
            RSVP Now
          </Link>
          <Link
